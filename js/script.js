...
let feuerChecker = 0;
var f_delay = 25000;        //Delay von den Hilfsbutton   
...
$(".f_steinzeitbutton").on("click", function () {
    ...
    if (clickCounter == feuerEintritt) {
        ...
        var f_steinzeit_meinTimeout = setTimeout(function () {
            $(".f_steinzeit_hilfe").slideDown()
        }, f_delay);
    }
    ...
    if (clickCounter == feuerEintritt + 1) {
        ...
        clearTimeout(f_steinzeit_meinTimeout);
...
$(".f_zukunftbutton").on("click", function () {
    ...
    if (f_clickCounter_zukunft == 1) {
        $(".f_zukunft_dialog_charakter").css({
            "visibility": "visible",
        })

    }
    if (f_clickCounter_zukunft == 2) {
        $(".f_zukunft_dialog_ueberwesen").css({
            "visibility": "visible",
        })
